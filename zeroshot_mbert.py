...
class ClassificationDataset(Dataset):
    def __init__(self, data_file: Path, tokenizer: BertTokenizer) -> None:
        super().__init__()
        self.input_ids = []
...
if __name__ == '__main__':
    ...
    bert_model = BertForSequenceClassification.from_pretrained(pretrained_model_name, num_labels=2)
