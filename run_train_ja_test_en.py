...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('trans_to_ja_train.csv')
        self.val_file = dataset_dir.joinpath('trans_to_ja_val.csv')
        self.test_file = dataset_dir.joinpath('trans_to_en_test.csv')
    ...
    def val_dataloader(self) -> DataLoader:
        return DataLoader(self.val_dataset, batch_size=self.batch_size, shuffle=False, num_workers=os.cpu_count(), pin_memory=True)
...
class Classifier(pl.LightningModule):
    def __init__(self, bert_model: AutoModelForSequenceClassification) -> None:
        super().__init__()
...
if __name__ == '__main__':
    ...
    bert_model = AutoModelForSequenceClassification.from_pretrained(pretrained_model_name, num_labels=2)
